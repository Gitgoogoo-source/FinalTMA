-- Phase 5 step 12 Mint enqueue transaction guards.
-- Keep the existing idempotent response contract, but make the RPC itself
-- enforce the wallet, item mint status, and active-lock checks.
