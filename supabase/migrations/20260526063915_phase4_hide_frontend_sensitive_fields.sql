-- Phase 4 / 4.4 frontend-sensitive response field redaction.
-- Keep full invitee UUIDs inside trusted tables/RPC inputs, but never return
-- tasks.referrals.invitee_user_id to frontend-facing JSON payloads.
