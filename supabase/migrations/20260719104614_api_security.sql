...
begin
  for v_table in
    ...
    from pg_tables
    where schemaname in ('identity', 'catalog', 'economy', 'inventory', 'gacha', 'evolution', 'expedition', 'wheel', 'battle', 'market', 'payments', 'vip', 'tasks', 'referral', 'album', 'onchain', 'operations', 'risk')
  loop
  ...
  foreach v_schema in array array['identity', 'catalog', 'economy', 'inventory', 'gacha', 'evolution', 'expedition', 'wheel', 'battle', 'market', 'payments', 'vip', 'tasks', 'referral', 'album', 'onchain', 'operations', 'risk', 'api']
  loop
...
revoke all on schema identity, catalog, economy, inventory, gacha, evolution, expedition, wheel, battle, market, payments, vip, tasks, referral, album, onchain, operations, risk, api from public, anon, authenticated;
revoke all on schema identity, catalog, economy, inventory, gacha, evolution, expedition, wheel, battle, market, payments, vip, tasks, referral, album, onchain, operations, risk from service_role;
