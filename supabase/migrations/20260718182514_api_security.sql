...
begin
  ...
  foreach v_schema in array array['identity', 'catalog', 'economy', 'inventory', 'gacha', 'expedition', 'wheel', 'market', 'payments', 'vip', 'tasks', 'referral', 'album', 'onchain', 'operations', 'risk', 'api']
  loop
