-- Phase 4 referral commission pending/claim flow.
-- Scope: fourth-stage plan section 2.6 referral and commission data strategy only.
...
comment on column tasks.referral_commissions.status is
  'pending means generated but not credited; granted means claimed and credited to ledger.';
...
drop function if exists api.referral_claim_commission(uuid, uuid[], text);
