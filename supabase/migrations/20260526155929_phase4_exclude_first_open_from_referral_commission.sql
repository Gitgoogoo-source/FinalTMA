-- Phase 4: prevent the invitee first-open order from also generating referral commission.
-- First-open orders only grant both-side 500 KCOIN rewards; later successful opens generate pending commission.
