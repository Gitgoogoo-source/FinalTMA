...
insert into _ids (key, id) select 'item_no_wallet_guard', testutil.create_item((select id from _ids where key = 'user'), (select id from _ids where key = 'template'), (select id from _ids where key = 'form1'), 1, 100, 'admin');
...
insert into _ids (key, id) select 'item_listed_guard', testutil.create_item((select id from _ids where key = 'user'), (select id from _ids where key = 'template'), (select id from _ids where key = 'form1'), 1, 100, 'admin');
...
select ok(testutil.raises_like(format('select api.wallet_enqueue_mint(%L::uuid, %L::uuid, %L::uuid, null::uuid, %L)', (select id::text from _ids where key = 'user'), (select id::text from _ids where key = 'item_no_wallet_guard'), (select id::text from _ids where key = 'collection'), 'mint-queue-no-wallet-guard'), '%wallet_id and idempotency_key are required%'), 'missing wallet cannot create mint queue');
select ok(testutil.raises_like(format('select api.wallet_enqueue_mint(%L::uuid, %L::uuid, %L::uuid, %L::uuid, %L)', (select id::text from _ids where key = 'user'), (select id::text from _ids where key = 'item_other_owner_guard'), (select id::text from _ids where key = 'collection'), (select id::text from _ids where key = 'wallet_id'), 'mint-queue-not-owner-guard'), '%not item owner%'), 'non-owner item cannot enter mint queue');
update inventory.item_instances set status = 'listed' where id = (select id from _ids where key = 'item_listed_guard');
select ok(testutil.raises_like(format('select api.wallet_enqueue_mint(%L::uuid, %L::uuid, %L::uuid, %L::uuid, %L)', (select id::text from _ids where key = 'user'), (select id::text from _ids where key = 'item_listed_guard'), (select id::text from _ids where key = 'collection'), (select id::text from _ids where key = 'wallet_id'), 'mint-queue-listed-guard'), '%item is not available for mint%'), 'listed item cannot enter mint queue');
update inventory.item_instances set status = 'consumed' where id = (select id from _ids where key = 'item_consumed_guard');
select ok(testutil.raises_like(format('select api.wallet_enqueue_mint(%L::uuid, %L::uuid, %L::uuid, %L::uuid, %L)', (select id::text from _ids where key = 'user'), (select id::text from _ids where key = 'item_consumed_guard'), (select id::text from _ids where key = 'collection'), (select id::text from _ids where key = 'wallet_id'), 'mint-queue-consumed-guard'), '%item is not available for mint%'), 'consumed item cannot enter mint queue');
update inventory.item_instances set status = 'decomposed' where id = (select id from _ids where key = 'item_decomposed_guard');
select ok(testutil.raises_like(format('select api.wallet_enqueue_mint(%L::uuid, %L::uuid, %L::uuid, %L::uuid, %L)', (select id::text from _ids where key = 'user'), (select id::text from _ids where key = 'item_decomposed_guard'), (select id::text from _ids where key = 'collection'), (select id::text from _ids where key = 'wallet_id'), 'mint-queue-decomposed-guard'), '%item is not available for mint%'), 'decomposed item cannot enter mint queue');
