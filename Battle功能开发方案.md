...
“游戏”页只渲染八种权威页面状态：Battle 首页、三槽队伍选择、挑战卡准备、等待、接受、双人 lobby、战斗、当场结果。三槽队伍选择的底部动作固定为左侧灰色次按钮“随机匹配”、右侧橙色主按钮“邀请好友”；同一 `waiting` 页面按 `room_mode` 分别渲染 30 分钟好友分享等待或 120 秒同档公开匹配等待。战斗页同时承载普通行动和倒下后的换宠反击，不存在独立换宠页面。
