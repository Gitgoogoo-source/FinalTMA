...
Bot 头像固定使用用户确认的金龙图。2026-08-27 的最新用户裁决按 [ADR-088](ADR-088-telegram-discovery-profile-and-public-info.md) 把同一金龙方向扩展到 Telegram 发现页、公开 Privacy/Terms 页面和对应上传母版；它仍不替换分享图、TON Connect manifest、Web 启动页或游戏内 UI。
