...
固定 210 张 768×768 WebP 正式母版保存在 `assets/source/catalog/v1`，不进入 Web 构建输出。Node.js 24 使用固定版本 `sharp@0.35.3` 为每张母版生成 256×256、quality 82 的缩略图和 768×768、quality 74 的详情图；两种输出均使用 WebP、effort 6、alphaQuality 100 和 Lanczos3 缩放并移除元数据。
