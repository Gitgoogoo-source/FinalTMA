...
| 5 K-coin 充值 | topup、stars-payment-recovery、navigation-intent-resume | payments、stars-payment workflow         | payments、economy               | Stars 成功后唯一交付、15 分钟过期、原意图只恢复确认 |
...
| 11 分解       | inventory                                               | inventory                                | inventory、economy              | 数量与 Fgems 在同一事务变化                         |
...
| 18 进化       | inventory                                               | inventory                                | inventory、economy、gacha       | 三材料、Fgems、路线保底和任务原子变化               |
| 19 顶部资产栏 | app/shell                                               | identity                                 | economy、vip、onchain           | 真实资产回正、钱包和 VIP 状态同步                   |
| 20 风控退款   | risk                                                    | refund-risk workflow、integrations、jobs | risk、payments、operations      | 重复退款无副作用、封禁空白门禁                      |
