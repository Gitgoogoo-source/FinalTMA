...
| Battle（第 21 章） | battle、battle-realtime         | battle、battle-share/outbox workflows    | battle、inventory、economy、operations   | viewer 隐私、三宠占用、秘密动作、超时托管、原子结算 |
...
- Battle 前端只为创建、取消、接受、正常动作和强制换宠提交对应意图与幂等键；heartbeat、offline 和 acknowledge 只提交目标房间且不提交幂等键。participant presence、lobby 倒计时、开战、命中、伤害、顺序、终局、退款与结算全部由数据库裁决。
