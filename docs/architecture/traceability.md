...
| 5 K-coin 充值 | topup | topup、integrations | payments、economy | Stars 成功后唯一交付、15 分钟过期 |
...
| 16 登录 | app/bootstrap | identity | identity、operations | initData、时间边界、3 次/分钟、短会话 |
...
| 20 风控退款 | app/shell | risk、integrations、jobs | risk、payments、operations | 重复退款无副作用、封禁空白门禁 |
