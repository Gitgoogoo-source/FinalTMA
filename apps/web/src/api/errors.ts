...
const API_ERROR_MESSAGES: Readonly<Record<string, string>> = {
  ...
  EVOLVE_ITEM_COUNT_INVALID: "合成必须选择 3 个藏品。",
  EVOLVE_DUPLICATE_ITEM_IDS: "合成材料不能重复。",
  ITEM_NOT_EVOLVABLE: "部分藏品当前不可合成。",
  EVOLVE_REQUIRES_SAME_TEMPLATE_AND_FORM: "合成需要 3 个同模板、同形态藏品。",
