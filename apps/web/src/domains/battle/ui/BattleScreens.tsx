...
function BattleHomeDuel(): ReactNode {
  return (
    <div className="battle-home-duel" aria-hidden="true">
      <div className="battle-home-pet self">
        <CatalogImage
          path="/assets/catalog/v1/detail/pet-a-020-3.webp"
          alt=""
          variant="detail"
          loading="eager"
          fetchPriority="high"
      ...
      <div className="battle-home-pet opponent">
        <CatalogImage
          path="/assets/catalog/v1/detail/pet-n-001-1.webp"
          alt=""
          variant="detail"
          loading="eager"
          fetchPriority="high"
