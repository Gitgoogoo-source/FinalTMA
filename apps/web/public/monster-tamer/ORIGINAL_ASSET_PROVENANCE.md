...
The world renderer uses only the fixed gameplay JSON's collision, encounter,
transition, sign, item, and foreground geometry. It does not sample, trace, or
transform upstream raster images that lacked direct license evidence.
