...
export const errorRegistry = {
  ...
  MONSTER_TAMER_BATTLE_ALREADY_ACTIVE: error(
    409,
    "已有进行中的战斗",
    false,
    "none",
  ...
  MONSTER_TAMER_BATTLE_NOT_FOUND: error(404, "战斗不存在"),
  MONSTER_TAMER_BATTLE_STATE_CONFLICT: error(
    409,
    "战斗状态已经更新，请重新同步",
    true,
    "none",
  ...
  MONSTER_TAMER_ENCOUNTER_UNAVAILABLE: error(
    409,
    "当前不能开始该遭遇",
    false,
    "none",
  ...
  MONSTER_TAMER_NODE_UNAVAILABLE: error(
    409,
    "当前不能使用该探索节点",
    false,
    "none",
  ...
  MONSTER_TAMER_NO_AVAILABLE_COLLECTIONS: error(
    409,
    "暂无可出战藏品",
    false,
    "inventory",
  ...
  MONSTER_TAMER_REGION_LOCKED: error(
    409,
    "区域尚未开放",
    false,
    "none",
  ...
  MONSTER_TAMER_STATE_CONFLICT: error(
    409,
    "游戏进度已经更新，请重新同步",
    true,
    "none",
  ...
  MONSTER_TAMER_TEAM_INVALID: error(
    409,
    "出战队伍包含不可用藏品，请重新组队",
    false,
    "inventory",
  ...
  RATE_LIMITED: error(429, "操作过于频繁，请稍后重试"),
  REFERRAL_ALREADY_BOUND: error(409, "邀请关系已经绑定"),
  REFERRAL_ALREADY_RECHARGED: error(409, "已有充值记录的账号不能绑定邀请码"),
  REFERRAL_CANDIDATE_EXPIRED: error(
    410,
    "邀请链接已失效，请重新通过原邀请链接进入",
  ),
  REFERRAL_CODE_INVALID: error(400, "邀请链接无效或已失效"),
  REFERRAL_INELIGIBLE: error(409, "当前账号暂不符合邀请绑定条件"),
  REFERRAL_INVALID: error(400, "邀请码无效"),
  REFERRAL_INVITER_UNAVAILABLE: error(409, "当前邀请链接暂不可用"),
  REFERRAL_OLD_USER: error(409, "老用户不能绑定邀请码"),
  REFERRAL_SELF_BIND: error(409, "不能使用自己的邀请码"),
  ...
  TELEGRAM_INIT_DATA_TIME_INVALID: error(
    401,
  ...
  TELEGRAM_START_PARAM_INVALID: error(
    400,
