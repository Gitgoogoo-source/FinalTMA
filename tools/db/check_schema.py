...
def verify_stars_payment_contract() -> None:
    ...
    required = {
        ...
        "callbacks": (
            ...
            "v_user.telegram_id <> p_payer_telegram_id",
            ...
            "p_payer_telegram_id <> v_order.verified_payer_telegram_id",
            "set status = 'payment_identity_conflict'",
            "payment_identity_conflict_reason = case",
            "set result = payments.order_json(v_order)",
        ...
        "jobs": (
            ...
            "payment_identity_conflict_delivery",
        ),
    }
    sources = {
